  ...
  <script type="text/javascript">
            ...
            return hapusin;
             ...
             if(isset($_GET['id']) == 'hapus'){
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM tambalban WHERE id='$id'");
					$gambar = $data['gambar'];
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class ="table-responsive">
                            ...
                            <a href="tambah-tambalban.php" class="btn btn-sm btn-success">Tambah Data</a>
                            </div>
							</div>
        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"responsive": true,
					"ajax":{
						url :"../controller/ajax-grid-tambalban.php", // json datasource
