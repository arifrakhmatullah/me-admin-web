...
?>
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Detail Laporan Lokasi Tambal Ban Tidak Valid</h2>
		...
		FROM laporan_tambalban WHERE id_laporan_tmb='".$_GET['ambil']."'");
			...
			?>
                   ...
                   <div class="form-group">
                           <center><img src="../../android/me-nambal/images/tambalban/<?php echo $row["gambar"]?>" width="100%" height="400px"></center>
                      </div>
                    ...
                    <div class="clearfix"></div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea class="form-control col-md-7 col-xs-12" readonly="readonly" ><?php echo $row["isi_laporan"]; ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						<center><a href="table-laporan-tambalban.php" class="btn btn-sm btn-danger">Kembali</a><center>
                      </div>
