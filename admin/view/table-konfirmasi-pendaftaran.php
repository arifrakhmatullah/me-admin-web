  ...
  <script type="text/javascript">
        ...
        if(hapusin==true){
            ...
            return hapusin;
             ...
             if(isset($_GET['id']) == 'hapus'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM tbl_daftar WHERE id_daftar='$id'");
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM tbl_daftar WHERE id_daftar='$id'");
					$delete = mysqli_query($koneksi, "DELETE FROM tbl_owner WHERE  id_owner='$id'");
					$foto_profil = $data['foto_profil'];
					unlink("../../android/me-nambal/images/pendaftaran/".$foto_profil);
					if($delete){
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    Data<code>Konfirmasi Pendaftaran</code> Dapat Dilihat Pada Table Di Bawah !
                    </p><br><br> 
        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"responsive": true,
					"ajax":{
						url :"../controller/ajax-grid-konfirmasi-pendaftaran.php", // json datasource
