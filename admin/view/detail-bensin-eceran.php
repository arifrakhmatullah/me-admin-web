...
?>
		...
		FROM bensineceran WHERE id_b='".$_GET['ambil']."'");
                   ...
                   <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="img-preview preview-lg">
                           <img src="../../android/me-nambal/images/bensineceran/<?php echo $row["gambar_b"]?>" width="100%" height="300px">
                        </div>
                      </div>
                    ...
                    <form class="form-horizontal form-label-left">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text"  value="<?php echo $row['jam_operasional_b']; ?>"class="form-control col-md-7 col-xs-12" readonly="readonly" >
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text"  value="<?php echo $row['harga_b']; ?>"class="form-control col-md-7 col-xs-12" readonly="readonly" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  value="<?php echo $row['no_hp_b']; ?>"class="form-control col-md-7 col-xs-12" readonly="readonly" >
                        </div>
                      </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea class="form-control col-md-7 col-xs-12" readonly="readonly"><?php echo $row['deskripsi_b']; ?></textarea>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  value="<?php echo $row['lat_b']; ?>"class="form-control col-md-7 col-xs-12" readonly="readonly" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text"  value="<?php echo $row['lng_b']; ?>"class="form-control col-md-7 col-xs-12" readonly="readonly" >
                        </div>
                      </div>
                      ...
                      <div class="ln_solid"></div>
                      <div class="form-group">
						<center><a href="table-bensin-eceran.php" class="btn btn-sm btn-danger">Kembali</a><center>
                      </div>
