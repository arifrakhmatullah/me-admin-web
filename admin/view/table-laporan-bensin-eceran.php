...
?>
             ...
             if(isset($_GET['id']) == 'hapus'){
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM laporan_bensineceran WHERE id_laporan_bns='$id'");
					if($delete){
			...
			?>
             ...
             <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Laporan User Bensin Eceran<small><b><i>Me-Nambal</i></b></small></h2>
        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"../controller/ajax-grid-laporan-bensin-eceran.php", // json datasource
